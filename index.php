    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
						<label for="name">Full Name</label>
						<input type="text" id="update_name" placeholder="Full name" class="form-control" />
					</div>
					...
					<div class="form-group">
						<label for="gender">Gender</label>
						<input type="radio" name="jenis_kelamin" value="Male" id="jenis_kelamin"> Male
						<input type="radio" name="jenis_kelamin" value="Female" id="jenis_kelamin"> Female
					</div>
